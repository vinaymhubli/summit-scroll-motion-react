      ...
      <section className="py-24 bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We work with leading technology brands and platforms to deliver 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center bg-gradient-to-br from-purple-900/30 to-blue-900/20 p-6 rounded-2xl border border-purple-500/20">
              <h3 className="text-lg font-bold text-white mb-2">Cisco</h3>
              <p className="text-gray-300 text-sm">Network Infrastructure</p>
            </div>
            <div className="text-center bg-gradient-to-br from-blue-900/30 to-purple-900/20 p-6 rounded-2xl border border-blue-500/20">
              <h3 className="text-lg font-bold text-white mb-2">Microsoft</h3>
              <p className="text-gray-300 text-sm">Server & Cloud Solutions</p>
            </div>
            <div className="text-center bg-gradient-to-br from-purple-900/30 to-blue-900/20 p-6 rounded-2xl border border-purple-500/20">
              <h3 className="text-lg font-bold text-white mb-2">VMware</h3>
              <p className="text-gray-300 text-sm">Virtualization Platform</p>
            </div>
            <div className="text-center bg-gradient-to-br from-blue-900/30 to-purple-900/20 p-6 rounded-2xl border border-blue-500/20">
              <h3 className="text-lg font-bold text-white mb-2">Dell</h3>
              <p className="text-gray-300 text-sm">Server Hardware</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-black via-purple-900/10 to-blue-900/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Your Network Technology Partner
              </h2>
              <p className="text-xl text-gray-300 mb-6">
                For over two decades, SummitUSA has been designing, implementing, and 
                supporting network infrastructure for businesses of all sizes. Our team 
                of certified engineers ensures your network operates at peak performance.
              </p>
              <p className="text-lg text-gray-400 mb-8">
                We understand that reliable network infrastructure is critical to your 
                business operations. That's why we focus on proactive monitoring, 
                preventive maintenance, and strategic planning to minimize downtime.
              </p>
              <Link 
                to="/about"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-purple-900/40 to-black/30 p-6 rounded-2xl border border-purple-500/30">
                <h3 className="text-xl font-bold text-white mb-3">Certified Engineers</h3>
                <p className="text-gray-300 text-sm">Industry-certified professionals with extensive experience</p>
              </div>
              <div className="bg-gradient-to-br from-blue-900/40 to-black/30 p-6 rounded-2xl border border-blue-500/30">
                <h3 className="text-xl font-bold text-white mb-3">Proven Results</h3>
                <p className="text-gray-300 text-sm">Track record of successful network implementations</p>
              </div>
              <div className="bg-gradient-to-br from-purple-900/40 to-black/30 p-6 rounded-2xl border border-purple-500/30">
                <h3 className="text-xl font-bold text-white mb-3">Latest Technology</h3>
                <p className="text-gray-300 text-sm">Cutting-edge solutions tailored to your needs</p>
              </div>
              <div className="bg-gradient-to-br from-blue-900/40 to-black/30 p-6 rounded-2xl border border-blue-500/30">
                <h3 className="text-xl font-bold text-white mb-3">24/7 Support</h3>
                <p className="text-gray-300 text-sm">Round-the-clock monitoring and support services</p>
              </div>
            </div>
          </div>
        </div>
