    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center py-32">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <button className="bg-gradient-to-r from-orange-500 to-blue-900 text-white px-8 sm:px-12 py-4 rounded-full text-lg sm:text-xl font-semibold hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-orange-500/50 whitespace-nowrap cursor-pointer">
              Get Started Today
            </button>
            <button className="border-2 border-white text-white px-8 sm:px-12 py-4 rounded-full text-lg sm:text-xl font-semibold hover:bg-white hover:text-black transition-all duration-300 whitespace-nowrap cursor-pointer">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center">
            <div className="space-y-4 scroll-animate-scale stagger-1">
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-400 to-blue-900 bg-clip-text text-transparent">
                1000+
              </div>
              <p className="text-lg sm:text-xl text-gray-300">IT Projects Delivered</p>
            </div>
            <div className="space-y-4 scroll-animate-scale stagger-2">
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-400 to-blue-900 bg-clip-text text-transparent">
                99.9%
              </div>
              <p className="text-lg sm:text-xl text-gray-300">System Uptime</p>
            </div>
            <div className="space-y-4 scroll-animate-scale stagger-3">
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-400 to-blue-900 bg-clip-text text-transparent">
                50+
              </div>
              <p className="text-lg sm:text-xl text-gray-300">IT Specialists</p>
            </div>
            <div className="space-y-4 scroll-animate-scale stagger-4">
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-400 to-blue-900 bg-clip-text text-transparent">
                24/7
              </div>
              <p className="text-lg sm:text-xl text-gray-300">Technical Support</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-gradient-to-br from-orange-900/40 to-blue-900/30 p-8 sm:p-12 rounded-3xl border border-orange-500/30 hover:border-orange-500/50 transition-all duration-300 cursor-pointer hover:transform hover:scale-105 scroll-animate-left stagger-1">
              ...
              ></div>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6">Cloud Solutions</h3>
            ...
            <div className="bg-gradient-to-br from-blue-900/40 to-orange-900/30 p-8 sm:p-12 rounded-3xl border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 cursor-pointer hover:transform hover:scale-105 scroll-animate stagger-2">
              ...
              ></div>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6">Cybersecurity</h3>
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-6">
            ...
            <div className="bg-gradient-to-br from-orange-900/40 to-blue-900/30 p-8 sm:p-12 rounded-3xl border border-orange-500/30 hover:border-orange-500/50 transition-all duration-300 cursor-pointer hover:transform hover:scale-105 scroll-animate-right stagger-3">
              ...
              ></div>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6">Custom Development</h3>
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-6">
            ...
            <div className="bg-gradient-to-br from-orange-900/30 to-blue-900/20 p-8 sm:p-12 rounded-3xl border border-orange-500/20 scroll-animate-left">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <div>
                    <p className="text-white font-bold text-lg sm:text-xl">Michael Rodriguez</p>
                    <p className="text-orange-400 text-sm sm:text-base">CEO, TechVision Solutions</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-900/30 to-orange-900/20 p-8 sm:p-12 rounded-3xl border border-blue-500/20 scroll-animate-right">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <div>
                    <p className="text-white font-bold text-lg sm:text-xl">Sarah Chen</p>
                    <p className="text-blue-400 text-sm sm:text-base">Founder, InnovateNow</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-2 scroll-animate-right">
              <div className="bg-gradient-to-br from-orange-500/20 to-blue-900/30 p-2 rounded-xl border border-orange-500/30">
                <div className="text-base sm:text-lg md:text-xl font-bold bg-gradient-to-r from-orange-400 to-blue-900 bg-clip-text text-transparent mb-1">
                  76%
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-1">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Cloud Computing</h3>
              <p className="text-sm sm:text-base text-gray-400">AWS, Azure, Google Cloud</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-blue-900/30 to-orange-900/20 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-2">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Cybersecurity</h3>
              <p className="text-sm sm:text-base text-gray-400">Network Security, Data Protection</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-3">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Software Development</h3>
              <p className="text-sm sm:text-base text-gray-400">Custom Apps, Web Development</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-blue-900/30 to-orange-900/20 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-4">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Network Infrastructure</h3>
              <p className="text-sm sm:text-base text-gray-400">LAN/WAN, VPN, Wireless</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-1">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Data Analytics</h3>
              <p className="text-sm sm:text-base text-gray-400">Big Data, Business Intelligence</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-blue-900/30 to-orange-900/20 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-2">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">AI & Machine Learning</h3>
              <p className="text-sm sm:text-base text-gray-400">Automation, Predictive Analytics</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-3">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">DevOps</h3>
              <p className="text-sm sm:text-base text-gray-400">CI/CD, Container Management</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-4">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Database Management</h3>
              <p className="text-sm sm:text-base text-gray-400">SQL, NoSQL, Data Migration</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-5">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Mobile Development</h3>
              <p className="text-sm sm:text-base text-gray-400">iOS, Android, Cross-Platform</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-6">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">IT Consulting</h3>
              <p className="text-sm sm:text-base text-gray-400">Digital Strategy, Tech Advisory</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-orange-900/30 to-blue-900/20 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-1">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Backup & Recovery</h3>
              <p className="text-sm sm:text-base text-gray-400">Disaster Recovery, Data Backup</p>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-br from-blue-900/30 to-orange-900/20 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 cursor-pointer scroll-animate-scale stagger-2">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">IT Support</h3>
              <p className="text-sm sm:text-base text-gray-400">24/7 Help Desk, Remote Support</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-orange-900/40 to-blue-900/30 p-6 sm:p-8 rounded-3xl border border-orange-500/30 scroll-animate-left stagger-1">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">New York Headquarters</h3>
              ...
              <div className="bg-gradient-to-br from-blue-900/40 to-orange-900/30 p-6 sm:p-8 rounded-3xl border border-blue-500/30 scroll-animate-left stagger-2">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">San Francisco Innovation Hub</h3>
                <p className="text-sm sm:text-base text-gray-300 mb-4">
              ...
              <div className="bg-gradient-to-br from-orange-900/40 to-blue-900/30 p-6 sm:p-8 rounded-3xl border border-orange-500/30 scroll-animate-left stagger-3">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">London European Office</h3>
                <p className="text-sm sm:text-base text-gray-300 mb-4">
      ...
      <section className="py-20 sm:py-32 bg-gradient-to-r from-orange-500 via-blue-900 to-orange-600">
        <div className="max-w-5xl mx-auto px-6 text-center scroll-animate">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button className="bg-white text-orange-900 px-12 sm:px-16 py-6 rounded-full text-lg sm:text-xl font-bold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl whitespace-nowrap cursor-pointer">
              Start Your Journey
            </button>
            <button className="border-2 border-white text-white hover:bg-white hover:text-black px-12 sm:px-16 py-6 rounded-full text-lg sm:text-xl font-semibold transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer">
